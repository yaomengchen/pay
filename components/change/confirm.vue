            ...
            <div class="title">
                <div class="toggle-bar">
                    <div class="toggle-bar-item">
                        <text class="toggle-bar-item-name">设置备用金</text>
                    </div>
                </div>
            ...
            <div class="toggle-bar-item-ref-area">
                <div class="swipe-container">
                    <div class="type-in-area type-in-area-1">
                        <input type="number" class="type-in-item" placeholder="请输入初始备用金" autofocus="true" v-model="inputText" return-key-type="defalut" @return = "submit"/>
                    </div>
                </div>
            </div>
