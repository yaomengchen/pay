<template>
    <div class="order-list" v-if="orderWait.length > 0">
        ...
        <scroller class="list-area-container">
            <div class="list-area">           
                ...
                <div class="list">
                    <div class="list-item" v-for="(order,orderIndex) in orderWait" :class="[(orderIndex==orderWait.length-1)?'list-item-last':'']" @click="toggleActiveItem(orderIndex)">
