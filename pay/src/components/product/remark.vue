    ...
    <div class="item" v-if="display" @click="close">
        <div class="preferential-modal" @click="stopClick">
            <div class="title">
                <div class="toggle-bar">
                    <div class="toggle-bar-item">
                        <text class="toggle-bar-item-name">整单备注</text>
                    </div>
                </div>
            ...
            <div class="swipe-container">
                <text class="tip">这里是【整单备注】，可点击列表中的商品添加【单品备注】</text>   
                <div class="radio" v-if="remarkList.length > 0">
                    <div class="radio-item" v-for="item in remarkList" @click="setValue(item.value)">
                        <text class="radio-text">{{item.value}}</text>
                    </div>
                </div>
                <div class="type-in-area type-in-area-2">
                    <textarea class="textarea" placeholder="输入备注" autofocus="true" v-model="remark"></textarea>
